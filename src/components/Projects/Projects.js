...
function Projects() {
  const projects = [
    {
      imgPath: eeg_tool,
      title: "Low-Cost Neurological Diagnosis (2025)",
      description:
    ...
    },
    {
      ...
      title: "Patent-Pending Biomedical Invention (2025)",
      description:
      ...
      links: [{ label: "Product", url: "https://vedsmehta.wixstudio.com/auctus-site" }],
    ...
    },
    {
      ...
      links: [{ label: "Speaker Bio", url: "https://neurologycongress.com/speaker/vedant-mehta" }],
      moreInfo: "Delivered a live technical talk in Orlando to global experts."
    },
    {
      imgPath: aimiStanford, // FIX: use the imported image
      title: "Chest X-Ray Annotation Pipeline (2024)",
      description:
      ...
      links: [{ label: "Paper", url: "https://ssrn.com/abstract=5051550" }],
      moreInfo: "Hybrid AI pipeline (NLP+Vision) for medical image labeling."
    },
    {
      imgPath: pinns,
      title: "PINNs for Biomedical Modeling (2024)",
      description:
      ...
      links: [{ label: "PyTorch", url: "#" }],
      moreInfo: "Physics-informed neural nets for biomedical simulations."
    },
    {
      imgPath: gis,
      title: "SilicoSensor (Genes in Space Finalist, 2024)",
      description:
      ...
      links: [
        {
          label: "Announcement",
          url: "https://www.genesinspace.org/news/press/announcing-the-2024-genes-in-space-finalists/"
        }
      ],
    ...
    },
    {
      ...
      title: "Media Recognition & Public Outreach (2024)",
      description:
      ...
      links: [
        {
          label: "Article",
          url:
            "https://www.forsythnews.com/news/education/reaching-stars-these-lambert-high-school-students-could-see-their-research-conducted-outer-space/"
        }
      ],
    ...
    {
      imgPath: sadd,
      title: "National Student Leadership Council – SADD (2024)",
      description:
      ...
      links: [{ label: "Profile", url: "https://www.sadd.org/studentleaders/vedant-mehta" }],
      moreInfo: "National youth leadership role promoting safe, healthy lifestyles."
    },
    {
      imgPath: biotreks,
      title: "Transgenic Biopesticide (BioTreks Publication, 2023)",
      description:
      ...
      links: [{ label: "Paper", url: "https://biotreks.org/wp-content/uploads/2023/10/e202317.pdf" }],
      moreInfo: "Synthetic biology solution for pest-resistant agriculture."
    },
    {
      imgPath: fbla,
      title: "FBLA Chapter Management Platform (2023)",
      description:
      ...
      links: [
        {
          label: "Abstract",
          url:
            "https://neurologycongress.com/program/scientific-program/2025/facilitating-emotional-regulation-through-brain-computer-interfaces"
        }
      ],
    ...
    },
    {
      ...
      title: "Colonoscopy Segmentation (2022)",
      description:
      ...
      links: [{ label: "Paper", url: "https://doi.org/10.1109/BIBE60311.2023.00079" }],
      moreInfo: "Deep learning for real-time polyp detection in endoscopy."
    },
    {
      imgPath: vit,
      title: "Vision Transformer (ViT) for CIFAR (2022)",
      description:
          ...
          {modalProject && (
            <>
              ...
              <Modal.Body>
                ...
                <p>
                  <strong>More Info:</strong> {modalProject.moreInfo}
                </p>
                <div>
