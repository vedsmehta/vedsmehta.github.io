...
![EffnetUnet](eunet.png)
> A 3D view of the neural network I developed.

![preds](preds.png)
> sample predictions from the network

This project has allowed me to showcase my skills at a conference in MIT, and at an upcoming international research conference in december.